...
function LoginContent() {
  ...
  return (
    <>
      <div className="flex gap-6 items-center justify-center h-screen w-full bg-gray-200 sm: px-16 flex-col md:flex-row">
        <div className="">
          <h1 className="text-[3rem] text-center md:text-start font-medium">
            BUZZBOX
          </h1>
          <p className="text-[1.5rem]  ">
            Buzzbox helps you connect and share with the people in your life.
          </p>
        </div>
      ...
      <div
        className={`h-screen ${
          signup ? "flex" : "hidden"
        } absolute inset-0 w-full bg-[#ffffffca]  items-center justify-center`}
      >
